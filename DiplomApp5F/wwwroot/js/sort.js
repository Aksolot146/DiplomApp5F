...
window.InitSort = {
    InitSort: function () {
        ...
        console.log("InitSort after return");
        ...
        console.log("InitSort after if");

        //for (var j = 0; (thead = document.getElementsByTagName("thead").item(j)); j++) {
        var thead = document.getElementById("sort");
            console.log("InitSort for");
            console.log(thead);
            var node;
...
//if (root){
//	if (root.addEventListener) root.addEventListener("load", initSort, false);
